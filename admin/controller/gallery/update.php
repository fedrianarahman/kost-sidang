...
$id = $_POST['id'];
$namaFasilitas = trim(strtolower($_POST['judul']));
...
$updateDataBank = mysqli_query($conn,"UPDATE `gallery` SET  `photo`='$photo',`judul`='$namaFasilitas',`created_at`='$created_at',`updated_at`='$updated_at' WHERE `id`='$id'");
