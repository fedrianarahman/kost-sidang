...
$updateDataBank = mysqli_query($conn,"UPDATE `fasilitas` SET  `photo`='$photo',`nama_fasilitas`='$namaFasilitas',`created_at`='$created_at',`updated_at`='$updated_at' WHERE `id`='$id'");
