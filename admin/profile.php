                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="./controller/user/updateProfile.php" method="POST" enctype="multipart/form-data">
                                    <?php
                                    $getDataUser = mysqli_query($conn, "SELECT * FROM user INNER JOIN role ON role.id = user.role_id WHERE user.id = '$idUser'");
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-auto ">
                                                <div class="picture-container">
                                                    <div class="picture">
                                                        <img src="./images/imageProfile/<?php echo $dataUser['photo'] ?>" class="picture-src " id="blah" title="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>NO HP</label>
                                                        <input class="form-control" type="text" name="no_hp" value="<?php echo $dataUser['no_telpon'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Alamat</label>
                                                        <input class="form-control" type="text" name="alamat" value="<?php echo $dataUser['alamat'] ?>">
                                                    </div>
                                                </div>
                                            </div>
